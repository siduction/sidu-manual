...
DATABASES = {
    'default': {
        ...
        'NAME': '/usr/share/sidu-manual/data/config.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '4v%po%*i^0lou(5pga#p)dlnqm0ye8h02jplsowafib@^%0-b7'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'request_handler': {
                'level':'DEBUG',
                'class':'logging.handlers.RotatingFileHandler',
                'filename': '/tmp/django_request.log',
                'maxBytes': 1024*1024*5, # 5 MB
                'backupCount': 5,
                'formatter':'standard',
        },
