...
1. Das Installationsprogramm startet man bequem über das Icon ![calamares icon](../../static/images-de/install-hd-de/calamares_00.png) am Desktop oder im Menü: *System* > *System installieren*.

2. Nach einem Doppelklick auf das Icon startet Calamares und wir sehen das "Willkommen" - Fenster.

   ![calamares welcome](../../static/images-de/install-hd-de/calamares_01.png "Willkommen")
   
   Sofern eine Internetverbindung besteht, ist hier bereits die richtige Sprache eingestellt.

3. Im nächsten Fenster "Standort" besteht die Möglichkeit Änderungen zur *Region*, der *Zeitzone* und *Systemsprache*, sowie dem *Format* für das Datum und Zahlen vorzunehmen.

   ![calamares location](../../static/images-de/install-hd-de/calamares_02.png "Standort") 

4.  Es folgen die Einstellungen zur Tastatur. 

   ![calamares keyboard](../../static/images-de/install-hd-de/calamares_03.png "Tastatur") 
...
5. Im nächsten Schritt erreichen wir die bereits oben erwähnte Partitionierung mit der bestimmt wird, welche Teile der Festplatte(n) siduction verwendet.
   ...
   ![calamares partitions](../../static/images-de/install-hd-de/calamares_04.png "Partitionen")
   ...
   ![calamares work on partitions](../../static/images-de/install-hd-de/calamares_05.png "Partitionen bearbeiten")
   ...
   ![calamares partitions finish](../../static/images-de/install-hd-de/calamares_06.png "Partitionen Ergebnis")
...
6. Als nächstes werden Benutzername, Anmeldename, Computername, Benutzerpasswort und Rootpasswort festgelegt (bitte gut merken!). Die Passwörter sollen aus Sicherheitsgründen nicht zu einfach gewählt werden. Weitere Benutzer können nach der Installation in einem Terminal mit [adduser](#adduser) hinzugefügt werden.
   ...
   ![calamares users](../../static/images-de/install-hd-de/calamares_07.png "Benutzer")
...
7. Nach Betätigen der Taste *Weiter* erscheint eine Zusammenfassung aller zuvor getätigten Eingaben. Jetzt besteht noch die Möglichkeit über *Zurück* Änderungen vorzunehmen. Sind wir mit dem Ergebnis zufrieden, öffnet ein Klick auf *Installieren* das kleine Warnfenster in dem wir die Instellation bestätigen müssen.

![calamares summary](../images-de/install-hd-de/calamares_08.png "Zusammenfassung") 

8. Nun startet die Installation. Dies dauert je nach Hardware einige Zeit. Der Fortschritt wird entsprechend angezeigt und am Ende erhalten wir die Möglichkeit zu einem Reboot in das neu installierte System. 
Auch wenn es etwas länger dauert, bitte die Installation nicht abbrechen, sondern dem Prozess Zeit geben.
...
<div id="rev">Page last revised by akli 2020-06-23</div>
