...
Das BIOS eines Computers sollte ab und an aktualisiert wrerden, wenn der Hersteller des Motherboards Verbesserungen der BIOS-Software vornimmt. Das Installationsprogramm ist in der Regel eine Anwendung auf MS-DOS-Basis.
...
** Drei Voraussetzungen: **
 ...
 1. ein USB-Stick: bevorzugt sind <2 GByte (FAT16 erlaubt nicht mehr als 2 GByte, aber eine vollständige FreeDOS-Installation benötigt nur 5.8 MByte). FAT16 ist empfohlen, da FAT32 nicht von jedem BIOS als bootfähig erkannt wird.
...
Das Partitions-Label wird auf FAT16 gesetzt, auf Sticks mit <2 GByte (dies bietet bessere Kompatibilität).
...
Die Installationsroutine fordert nun zu einem Reboot auf - <span style="color:red">** dies verschieben wir noch etwas, da noch zwei Fehler des FreeDOS Installers bezüglich mbr und Bootmenü behoben werden müssen **</span>. Man gibt den Buchstaben n ein.  
&nbsp;  
&nbsp;  
...
<span style="color:red">Ansonsten darf nichts geändert werden, da die Zeile von dem Installations-Setup abhängt.</span>  
...
Der USB-Stick ist nun bootfähig und enthält eine vollständige FreeDOS-Installation mit 5,4 MByte, um das BIOS flashen zu können. <span style="color:red">Man sollte booten, ohne Treiber zu laden (Menüoption 4), himem.sys und emm386 könnten in die Flashing-Programme reinpfuschen!</span>  
